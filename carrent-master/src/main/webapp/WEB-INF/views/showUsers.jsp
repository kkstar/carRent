                                ...
                                <table id="datatable" class="table table-striped table-bordered">
                                    ...
                                    <c:forEach var="user" items="${users}" varStatus="s">
                                        <tr>
                                            ...
                                            <td>${user.email}</td>
                                            <td>${user.phone}</td>
                                            <td>${user.userType.utypename}</td>
                                            <td>
                                                <a href="<%=request.getContextPath() %>/backManage/changeUserType?userId=${user.userid}&userTypeId=${user.userType.utypeid}" class="btn btn-primary btn-xs"><i class="fa fa-user"></i> 改变用户类型 </a>
                                                <a href="<%=request.getContextPath() %>/backManage/deleteUser?userId=${user.userid}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> 删除 </a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
